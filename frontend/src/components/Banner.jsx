    ...
    return (
        <div className='flex bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10 overflow-hidden'>
            ...
            <div className='flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5 min-w-0'>
                ...
                <button onClick={() => { navigate('/login'); scrollTo(0, 0) }} className='bg-white text-sm sm:text-base text-emerald-600 font-medium px-8 py-3 rounded-full mt-6 hover:scale-105 hover:shadow-lg transition-all duration-300'>Create account</button>
            </div>
