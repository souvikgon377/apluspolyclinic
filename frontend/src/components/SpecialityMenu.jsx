...
const SpecialityMenu = () => {
    return (
        <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-[#262626] overflow-x-hidden'>
            ...
            <div className='flex sm:justify-center gap-4 pt-5 w-full overflow-x-scroll px-4'>
