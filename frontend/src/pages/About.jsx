    ...
    <div>
        ...
        <div className='my-10 flex flex-col md:flex-row gap-12'>
            ...
            <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
                ...
                <p>Welcome to A Plus Polyclinic, founded by Dr. Amit Gupta with a vision to provide comprehensive, high-quality healthcare services to the community. With years of expertise in general and laparoscopic surgery, Dr. Gupta established A Plus Polyclinic to offer accessible, patient-centered medical care.
                </p>
                <p>A Plus Polyclinic is a multi-specialty healthcare facility equipped with modern medical technology and staffed by experienced healthcare professionals. We specialize in providing personalized treatment plans, advanced surgical procedures, and preventive care. Our clinic is committed to excellence in healthcare delivery, ensuring every patient receives compassionate and efficient medical attention.
                </p>
                <b className='text-gray-800'>Our Vision</b>
                <p>Our vision at A Plus Polyclinic is to create a seamless healthcare experience for every patient. We aim to bridge the gap between patients and healthcare providers through convenient online appointment booking, modern facilities, and expert medical care. We strive to make quality healthcare accessible, efficient, and reliable for everyone in our community.
                </p>
            </div>
        </div>
