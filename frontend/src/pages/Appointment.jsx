    ...
    return docInfo ? (
        <div className='overflow-x-hidden max-w-full'>
            ...
            <div className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex-1 border border-[#ADADAD] rounded-lg p-4 sm:p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0 min-w-0'>

                    {/* ----- Doc Info : name, degree, experience ----- */}

                    <p className='flex items-center gap-2 text-2xl sm:text-3xl font-medium text-gray-700 break-words'>{docInfo.name} <img className='w-5 flex-shrink-0' src={assets.verified_icon} alt="" /></p>
                    <div className='flex items-center gap-2 mt-1 text-gray-600 flex-wrap'>
                        <p className='break-words'>{docInfo.degree} - {displaySpeciality(docInfo.speciality)}</p>
                        <button className='py-0.5 px-2 border text-xs rounded-full'>{docInfo.experience}</button>
                    </div>

                    {/* ----- Doc About ----- */}
                    <div className='overflow-x-hidden'>
                        <p className='flex items-center gap-1 text-sm font-medium text-[#262626] mt-3'>About <img className='w-3 flex-shrink-0' src={assets.info_icon} alt="" /></p>
                        <p className='text-sm text-gray-600 max-w-full sm:max-w-[700px] mt-1 break-words'>{docInfo.about}</p>
                    </div>
