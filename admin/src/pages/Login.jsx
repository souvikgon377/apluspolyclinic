  ...
  return (
    <form onSubmit={onSubmitHandler} className='min-h-[80vh] flex items-center'>
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-[#5E5E5E] text-sm shadow-lg'>
        ...
        <button className='bg-gradient-to-r from-emerald-500 to-cyan-500 text-white w-full py-2 rounded-md text-base font-medium hover:shadow-lg transition-all'>Login</button>
        ...
        {state === 'Doctor' && (
          <>
            ...
            <button 
              ...
              className='flex items-center justify-center gap-3 w-full py-2 border border-[#DADADA] rounded-md text-base hover:bg-gray-50 transition-colors'
            >
