  ...
  return (
    <div className='w-full max-w-6xl mx-auto px-4 py-8 overflow-x-hidden'>
      ...
      <div className='bg-white border border-gray-100 rounded-xl shadow-md text-sm max-h-[80vh] overflow-y-scroll overflow-x-hidden'>
        <div className='max-sm:hidden grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-1 py-4 px-6 border-b border-gray-100 bg-gray-50 font-semibold text-gray-700'>
          <p>#</p>
          <p>Patient</p>
          <p>Payment</p>
          <p>Age</p>
        ...
        {appointments.length === 0 ? (
          ...
          appointments.map((item, index) => (
            <div className='sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-1 items-center text-gray-500 py-4 px-4 sm:px-6 border-b border-gray-50 hover:bg-gray-50 transition-colors last:border-b-0' key={index}>
